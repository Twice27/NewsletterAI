"""
NewsletterAI — Email newsletter automation with personalization
...
log = logging.getLogger("newsletterai")
...
class Router:
    """Cost- and latency-aware model router for NewsletterAI."""
...
if __name__ == "__main__":
    import argparse
    p = argparse.ArgumentParser(description="NewsletterAI: Email newsletter automation with personalization")
